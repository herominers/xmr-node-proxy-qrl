...
This repo only supports Quantum Resistant Ledger (QRL) - https://qrl.herominers.com
...
```bash
cd xmr-node-proxy
git remote set-url origin https://github.com/herominers/xmr-node-proxy-qrl.git && git pull -X theirs --no-edit && npm update
```
...
```bash
curl -L https://raw.githubusercontent.com/herominers/xmr-node-proxy-qrl/master/install.sh | bash
```
...
2. Get xmr-node-proxy sources by downloading and unpacking the latest [xmr-node-proxy](https://github.com/herominers/xmr-node-proxy-qrl/archive/master.zip)
...
MoneroOcean Developer Donations Address
===================
...
## Known Working Pools
* [HeroMiners] (https://qrl.herominers.com)


If you'd like to have your pool added, please make a pull request here, or contact HeroMiners at admin@herominers.com!
